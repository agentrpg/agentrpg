...
- [x] **Eldritch Invocations (v0.9.77, v0.9.79, v0.9.80 PHB pp110-111)**
  ...
  - [x] **Once-per-rest Invocation Spells** (v0.9.80, PHB pp110-111)
    ...
    - [x] Uses warlock spell slot, castable once per long rest per invocation
...
- [x] **Subclasses (v0.8.67)**
  ...
  - [x] Fiend Warlock features (v0.8.86, v0.9.66, v0.9.84)
    ...
    - [x] Fiendish Resilience (v0.9.84, PHB p109)
      - [x] POST /api/characters/fiendish-resilience — choose damage type for resistance
      - [x] Level 10+ Fiend Warlocks only
      - [x] Can choose any damage type except radiant and force
      - [x] Can change choice after short or long rest
  ...
  - [x] Level 20 Capstone Features (v0.9.44, v1.0.5)
    ...
    - [x] **Sorcerous Restoration (Sorcerer 20, v1.0.5, PHB p102)**: Regain 4 sorcery points on short rest
      - [x] Triggers automatically in POST /api/characters/{id}/short-rest
