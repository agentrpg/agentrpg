-- 5e SRD Rule Sections (CC-BY-4.0)
-- Generated: 2026-02-25T09:32:16.328Z
-- Source: https://www.dnd5eapi.co

INSERT INTO rule_sections (slug, name, description, source) VALUES (
  'ability-checks', 'Ability Checks', '## Ability Checks
...
INSERT INTO rule_sections (slug, name, description, source) VALUES (
  'ability-scores-and-modifiers', 'Ability Scores and Modifiers', '## Ability Scores and Modifiers
...
INSERT INTO rule_sections (slug, name, description, source) VALUES (
  'actions-in-combat', 'Actions in Combat', '## Actions in Combat
...
INSERT INTO rule_sections (slug, name, description, source) VALUES (
  'activating-an-item', 'Activating an Item', '## Activating an Item
...
INSERT INTO rule_sections (slug, name, description, source) VALUES (
  'advantage-and-disadvantage', 'Advantage and Disadvantage', '## Advantage and Disadvantage
...
INSERT INTO rule_sections (slug, name, description, source) VALUES (
  'between-adventures', 'Between Adventures', '## Between Adventures
...
The training lasts for 250 days and costs 1 gp per day. After you spend the requisite amount of time and money, you learn the new language or gain proficiency with the new tool.', 'srd'
) ON CONFLICT (slug) DO NOTHING;
INSERT INTO rule_sections (slug, name, description, source) VALUES (
  'casting-a-spell', 'Casting a Spell', '## Casting a Spell
...
INSERT INTO rule_sections (slug, name, description, source) VALUES (
  'damage-and-healing', 'Damage and Healing', '## Damage and Healing
...
INSERT INTO rule_sections (slug, name, description, source) VALUES (
  'fantasy-historical-pantheons', 'Fantasy-Historical Pantheons', '## Fantasy-Historical Pantheons
...
| Uller, god of hunting and winter          | CN        | Nature            | Longbow                           |', 'srd'
) ON CONFLICT (slug) DO NOTHING;
INSERT INTO rule_sections (slug, name, description, source) VALUES (
...
INSERT INTO rule_sections (slug, name, description, source) VALUES (
  'making-an-attack', 'Making an Attack', '## Making an Attack
...
INSERT INTO rule_sections (slug, name, description, source) VALUES (
  'mounted-combat', 'Mounted Combat', '## Mounted Combat
...
INSERT INTO rule_sections (slug, name, description, source) VALUES (
  'movement-and-position', 'Movement and Position', '## Movement and Position
...
***Wyvern Poison (Injury).*** This poison must be harvested from a dead or incapacitated wyvern. A creature subjected to this poison must make a DC 15 Constitution saving throw, taking 24 (7d6) poison damage on a failed save, or half as much damage on a successful one.', 'srd'
) ON CONFLICT (slug) DO NOTHING;
INSERT INTO rule_sections (slug, name, description, source) VALUES (
  'proficiency-bonus', 'Proficiency Bonus', '## Proficiency Bonus
...
INSERT INTO rule_sections (slug, name, description, source) VALUES (
  'sentient-magic-items', 'Sentient Magic Items', '## Sentient Magic Items
...
INSERT INTO rule_sections (slug, name, description, source) VALUES (
  'standard-exchange-rates', 'Standard Exchange Rates', '## Standard Exchange Rates
| Coin          | CP    | SP   | EP   | GP    | PP      |
|---------------|-------|------|------|-------|---------|
...
| Platinum (pp) | 1,000 | 100  | 20   | 10    | 1       |', 'srd'
) ON CONFLICT (slug) DO NOTHING;
INSERT INTO rule_sections (slug, name, description, source) VALUES (
...
INSERT INTO rule_sections (slug, name, description, source) VALUES (
  'the-order-of-combat', 'The Order of Combat', '## The Order of Combat
...
INSERT INTO rule_sections (slug, name, description, source) VALUES (
  'the-planes-of-existence', 'The Planes of Existence', '## The Planes of Existence
...
INSERT INTO rule_sections (slug, name, description, source) VALUES (
  'underwater-combat', 'Underwater Combat', '## Underwater Combat
...
Creatures and objects that are fully immersed in water have resistance to fire damage.', 'srd'
) ON CONFLICT (slug) DO NOTHING;
INSERT INTO rule_sections (slug, name, description, source) VALUES (
  'using-each-ability', 'Using Each Ability', '## Using Each Ability
...
INSERT INTO rule_sections (slug, name, description, source) VALUES (
  'wearing-and-wielding-items', 'Wearing and Wielding Items', '## Wearing and Wielding Items
...
INSERT INTO rule_sections (slug, name, description, source) VALUES (
  'what-is-a-spell', 'What Is a Spell?', '## What Is a Spell?
